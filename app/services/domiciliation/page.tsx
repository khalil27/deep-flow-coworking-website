...
export default function DomiciliationPage() {
  const offers = domiciliationOffers
    ...
    <div className="min-h-screen">
      ...
      <main className="bg-gradient-to-br from-[#334247] to-[#4f8fa3] pt-20 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Domiciliation</h1>
          <p className="text-lg text-[#b4c7d4] mb-12">Professional business address services for your company registration and mail handling</p>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-[#b4c7d4]/30 rounded-lg p-8">
            <h3 className="text-2xl font-bold text-white mb-4">Domiciliation Features</h3>
