...
export default function TrainingRoomPage() {
  const [offers] = useState(trainingRoomOffers)
    ...
    <div className="min-h-screen">
      ...
      <main className="bg-background pt-20 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Conference Rooms</h1>
          <p className="text-lg text-muted-foreground mb-12">Fully equipped training and conference spaces perfect for workshops, seminars, and events</p>
